...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('/public/img/utpl-ranking-cabecera_1.png'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Bienvenido!</h1>
                        <p class="text-lead text-white">Usted puede registrarse fácilemnte en este formulario.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="organizacion" class="form-control" placeholder="Organizacion" aria-label="Name" value="{{ old('organizacion') }}" >
                                    @error('organizacion') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                ...
                                <p class="text-sm mt-3 mb-0">Ya tiene una cuenta? <a href="{{ route('login') }}"
                                        class="text-dark font-weight-bolder">Acceder</a></p>
                            </form>
                        </div>
                    </div>
                </div>
