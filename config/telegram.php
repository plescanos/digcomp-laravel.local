...
return [
    ...
    */
    'bots' => [
        'digcomp_tester' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '6519055141:AAFAGMm7ci2C79HHUKEpK3RbbcLVQpUIyQ0'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://09f6-45-225-44-40.ngrok-free.app/webhook'),
            'commands' => [
